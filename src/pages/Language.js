...
const Language = () => {
  ...
  return (
    <div>
      <h1>Language List</h1>
      <Link to="/language?type=add">Add Language</Link>
      {loading ? (
        <p>Loading..</p>
      ) : (
        <>
          <ul>
            {languageList.length > 0 ? (
              languageList.map((language) => (
                <li key={language.lang_id}>
                  <p>{language.lang_name}</p>
                  <ul>
                    <li>
                      <button onClick={() => handleEdit(language.lang_id)}>
                        <Pencil />
                      </button>
                    </li>
                    <li>
                      <button onClick={() => handleDelete(language.lang_id)}>
                        <Trash2 />
                      </button>
                    </li>
                  </ul>
